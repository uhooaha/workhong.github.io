...
$(function(){
	...
	$("#visual1 p .l1").click(function(){

		$("#visual1").animate({opacity:0},500,"easeInOutExpo");
		$("#visual2").animate({opacity:1},500,"easeInOutExpo");
		return false;	
		
	});
	
	$("#visual2 p .l1").click(function(){

		$("#visual1").animate({opacity:1},500,"easeInOutExpo");
		$("#visual2").animate({opacity:0},500,"easeInOutExpo");
		return false;
